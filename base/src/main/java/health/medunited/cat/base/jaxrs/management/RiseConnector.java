package health.medunited.cat.base.jaxrs.management;
...
import health.medunited.cat.base.LoggingFilter;
  ...
  Response connectAndRetrieveResponse(String httpMethod, String path, Client client,
    ...
    if (Objects.equals(httpMethod, GET)) {
      ...
      return invocationBuilder.post(Entity.json(
          new ManagementCredentialsRISE(managementCredentials.getUsername(),
