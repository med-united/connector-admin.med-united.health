package health.medunited.cat.base.provider;
...
import health.medunited.cat.base.service.endpoint.SSLUtilities;
...
public class ConnectorServicesProducer {
  ...
  private void initializeServices(boolean throwEndpointException) {
    try {
      endpointDiscoveryService.obtainConfiguration(httpServletRequest.getHeader("x-host"),
          httpServletRequest.getHeader("x-basic-auth-username"),
          httpServletRequest.getHeader("x-basic-auth-password"));
    } catch (Exception e) {
  ...
  public void initializeCertificateServicePortType(String basicAuthUsername,
  ...
  private void configureServicePortType(BindingProvider portType, String endpointAddress,
