package health.medunited.cat.lib.service.endpoint;
...
public class EndpointDiscoveryService {
  ...
  public byte[] obtainFile(String connectorBaseUrl, String basicAuthUsername,
    ...
    Invocation invocation = buildInvocation(client, connectorBaseUrl, basicAuthUsername,
        basicAuthPassword);
    try {
      return invocation
  ...
  private Client buildClient(long timeoutSeconds) {
    return ClientBuilder
        ...
        .hostnameVerifier(new SSLUtilities.FakeHostnameVerifier())
        .build();
  }
