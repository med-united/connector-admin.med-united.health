sap.ui.define(
  ...
  function (AbstractMasterController, JSONModel, vega5js, vega5embedjs) {
    "use strict";
    ...
    return AbstractMasterController.extend(
      "sap.f.ShellBarWithFlexibleColumnLayout.controller.Dashboard",
      {
        onInit: function () {
          ...
          fetch("/connector/event/get-cards", { headers: KopsHeader }).then(
            (response) => {
