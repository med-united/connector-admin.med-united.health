...
public class RiseConnector extends AbstractConnector {
    ...
    public void restart(String connectorUrl, String managementPort, ManagementCredentials managementCredentials) {
        log.info("[" + connectorUrl + "] Restarting connector...");

        Client client = setUpHTTPClient();
        ...
        log.info("[" + connectorUrl + "] Login response code: " + login.getStatus());
        login.close();
        ...
        log.info("[" + connectorUrl + "] Restart response code: " + restart.getStatus());
        restart.close();
    }
    ...
    public boolean isTIOnline(String connectorUrl, String managementPort, ManagementCredentials managementCredentials) {
        log.info("[" + connectorUrl + "] Checking status of TI...");
    ...
    public static Client setUpHTTPClient() {
