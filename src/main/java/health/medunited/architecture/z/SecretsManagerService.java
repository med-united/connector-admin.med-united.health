...
public class SecretsManagerService {
    ...
    public void createSSLContext(String ssl) {
        try {
            String certificate = ssl.split("__")[0];
            String certificatePassword = ssl.split("__")[1];
            setUpSSLContext(getKeyFromKeyStoreUri(certificate, certificatePassword));
